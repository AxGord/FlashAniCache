...
class Animation extends Sprite
{
	...
	public var playing(isPlaying, null):Bool;
	
	public var sX:Float;
	public var sY:Float;
		
	public function new(sX:Float = 1, sY:Float = 1) 
	{
		this.sX = sX;
		this.sY = sY;
		super();
	...
	public function buildCacheFromClip(clip:MovieClip, ?rectangle:Rectangle=null):Void
	{
		...
		for (i in 1...clip.totalFrames+1)
		{
			...
			var bitmapData:BitmapData = new BitmapData(Std.int(rect.width*sX), Std.int(rect.height*sY), true, 0x00000000);
